			...
			<div class="col-sm-12 d-flex justify-content-center">
				<div class="card mx-auto my-auto" style="width: 500px; min-height: 300px;">
				    ...
				    <div class="text-center">
							...
							<h5>Sign in</h5>
							<form class="mb-4" action="backend/proses_login.php" method="POST">
								<div>
									<input class="form-control mb-1" type="text" placeholder="Username" name="username">
									<input class="form-control" placeholder="Password" type="password" name="password">
								</div>
								<button class="btn btn-custom mt-4">Sign in</button>
							</form>
							<span>Belum punya akun? <a class="color-custom" href="register.html">Register</a></span>
						</div>
					</div>
				</div>
			</div>
